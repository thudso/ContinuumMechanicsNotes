...
$\nabla\theta=\bf0$, then @eq-C-DEulerian2 implies that $\delta\geq0$, i.e. the
...
::: {.callout-note icon="false"}
## Frame Indifference
The spatial mass density $\rho$, temperature $\theta$, entropy per unit mass $\eta$,
...
order to comply with **Frame Indifference**, we must have $$\begin{aligned}
