...
Analysis and Vector Calculus. In
Chapters \@ref(cha:tensor-algebra) and
\@ref(cha:tensor-calculus), we therefore recap various concepts
...
Chapter \@ref(cha:kinematics) introduces the study of kinematics, or the
...
Chapter \@ref(cha:balance-laws), we combine these concepts to derive
...
[Dr Thomas Hudson](https://sites.google.com/view/thudso/), Janury 2025