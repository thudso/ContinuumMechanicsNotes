...
$$
  \bfr(\Omega) = \bfr_b(\Omega)+\bfr_s(\partial\Omega) = \int_\Omega \rho(\bfx)\bfb(\bfx)\dVx+\int_{\partial\Omega}\bft(\bfx)\dAx,
$$ { #eq-resultantforce }
...
\begin{aligned}
  ...
  \end{aligned}
$$ { #eq-resultanttorque }
At a static equilibrium, we assume that both the resultant force and torque for any $\Omega$ vanish, which is encoded in
the following axiom.
